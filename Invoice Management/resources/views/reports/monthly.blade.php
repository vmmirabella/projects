...
<div class="row" style="margin-top:50px">	
	<form class="form-inline" style="padding-top:50px;padding-bottom:50px;" id="dateRange" action="{{action('ReportController@monthly')}}" method="GET" >
	...
	var plot1 = $.jqplot('chart', [data], {
			...
			axes:{
				xaxis:{
					...
					tickOptions:{formatString:'%b-%Y', angle: -90},
